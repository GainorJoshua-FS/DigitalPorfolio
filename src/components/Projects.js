    ...
    return (
        <section style={styles.section}>
            ...
            <div style={styles.div}>
                ...
                />
                <ProjectHelper
                    title="JQG Kanban Board" src={KanHome} alt="A Kanban board website" src2={KanNew} alt2="The Kanban's new task screen" desc="A simple JavaScript website that mimics a standard kanban board. Pulls from an API and has a custom built light/dark mode" git="https://github.com/GainorJoshua-FS/JQG-Kanban" page="/kanban"
                />
                <ProjectHelperWide
